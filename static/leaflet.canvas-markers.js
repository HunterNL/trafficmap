...
// Origin: https://github.com/eJuke/Leaflet.Canvas-Markers/blob/master/src/plugin/leaflet.canvas-markers.js
// Thank you contributors <3

// Minor edits have been made to the _redraw function to support transparency
...
function layerFactory(L) {
    ...
    var CanvasIconLayer = (L.Layer ? L.Layer : L.Class).extend({
        ...
        _drawImage: function (marker, pointPos) {
            ...
            // START EDIT TO SUPPORT OPACITY
            this._context.globalAlpha = (typeof this.options.opacity == "number" ? this.options.opacity : 1)
            // EDIT EDIT
        ...
        _redraw: function (clear) {
            ...
            // this._context.globalAlpha = oldOpacity // EDIT TO SUPPORT OPACIY
